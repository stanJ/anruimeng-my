...
!function ($) {
  ...
  var setValue = function() {
    ...
    $container.find(toggleSelector+ ' span').not('.op-sp').html($target.html())
  ...
  var Modal = function (element, options) {
    ...
    if (element === null) {
      var TPL = ''
        ...
        //添加options.type用来区分不同类型的modal by stanJ
        + '<div class="sui-modal hide fade '+options.type+'" tabindex="-1" role="dialog" id={%id%} data-hidetype="remove">'
...
!function ($) {
    ...
    Pagination.prototype = {
        ...
        _draw: function () {
            ...
            tpl += '"></div>';
            tpl += '<div class="pagination-centered pagination-label">(当前第'+this.currentPage+'页/共'+this.pages+'页,'+(this.itemsCount?this.itemsCount:45)+'条记录)</div>';
        ...
        _drawCtrl: function () {
            ...
            '<span>' + '&nbsp;到第&nbsp;' + '<input type="text" class="page-num"/>' + '&nbsp;页' + '<button class="page-confirm">确定</button></span>' + '</div>';
            return tpl;
        },
        ...
        updatePagesAndItemsCount: function (pages, pageToGo,itemsCount) {
            $.isNumeric(pages) && (this.pages = pages);
            this.currentPage = this.currentPage > this.pages ? this.pages : this.currentPage;
            $.isNumeric(pageToGo) && (this.currentPage = pageToGo);
